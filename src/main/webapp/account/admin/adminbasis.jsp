      ...
      <div style="width:100%;text-align:center">   	
			 <table class = "tests">
	          <tr>
	               ...
	               <th><fmt:message key = "add.question" bundle ="${lang}"/></th>
	               <th><fmt:message key = "test.edit" bundle ="${lang}"/></th>
	               <th><fmt:message key = "test.delete" bundle ="${lang}"/></th>
	          </tr>
	          ...
	          <c:forEach items="${tests}" var="test">		          	               	      
	                <tr>         	
			               ...
			               <td>       	
            					...
            					<td>
            						<form action="/StudentTestingApp/Servlet" method="post">
				               		<fmt:message key="add" var="buttonPlaceholder" bundle ="${lang}" />
				               		<input class='tableButtons' type='submit' value="${buttonPlaceholder}"/>
				               		<input type="hidden" name="testId" value="${test.id}"/>
				               		<input type="hidden" name="command" value="fillQuestionData"/>
			               		</form>
			               		</td>
			               	<td>
			               		<form action="/StudentTestingApp/Servlet" method="post">
				               		<fmt:message key="test.edit" var="buttonPlaceholder" bundle ="${lang}" />
				               		<input class='tableButtons' type='submit' value="${buttonPlaceholder}"/>
				               		<input type="hidden" name="testId" value="${test.id}"/>
				               		<input type="hidden" name="command" value="fillTestData"/>
			               		</form>
			               	</td>
			               		<td>
			               		<form action="/StudentTestingApp/Servlet" method="post">
