      ...
      <div>   	
			 <div class="test-create-form">	 
		         ...
		         <form action="/StudentTestingApp/Servlet" method="POST">		         		 
		             ...
		             <input type="text" class="input-field" placeholder="${testNameEnglishPlaceholder}" name="englishName" required> <br>
		             ...
		             <input type="text" class="input-field" placeholder="${testNameRussianPlaceholder}" name="russianName" required> <br>
		             
		             <h4>
		         		<fmt:message key = "test.duration" bundle ="${lang}"/>
		         	 </h4>	 
		         	 <fmt:message key = "test.duration" var="durationPlaceholder"  bundle ="${lang}"/>
		             <input type="number" class="input-field" placeholder="${durationPlaceholder}" name="duration" min="0" max="180" required> <br>	       
		             <label>  
			             <h4>
